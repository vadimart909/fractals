...
SetParameters();
mainWindow->Panel1->Hide();
mainWindow->ToolBar1->Hide();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void TlSystemForm::SetDisplay(int SetCenter)
{
if(SetCenter){
x0 = ClientWidth / 2;
...
void __fastcall TlSystemForm::FormMouseDown(TObject *Sender,
...
void __fastcall TlSystemForm::FormActivate(TObject *Sender)
{
mainWindow->Panel1->Hide();
mainWindow->ToolBar1->Hide();
}
...
void __fastcall TlSystemForm::FormDeactivate(TObject *Sender)
{
